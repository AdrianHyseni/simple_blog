const homeObjOne ={
  ...
  const tripleCards = {
    ...
    firstCardName: 'Peaceful Lifestyle',
    firstCardp: "“Never be in a hurry; do everything quietly and in a calm spirit. Do not lose your inner peace for anything whatsoever, even if your whole world seems upset.” —Saint Francis de Sales",
    firstCardBtn:'Learn More',
    
    secondicon: 'fa-magnet',
    secondCardTitleName:'Saying',
    secondCardName: 'Never Give Up',
    secondCardp: "“All our dreams can come true, if we have the courage to pursue them.” – Walt Disney",
    secondCardBtn:'Learn More',

    thirdicon: 'fa-hashtag',
    thirdCardTitleName:'Saying',
    thirdCardName: 'Let Them Talk',
    thirdCardp: "“If people are doubting how far you can go, go so far that you can’t hear them anymore.” – Michele Ruiz",
    thirdCardBtn:'Learn More',

      
  }

  export {tripleCards,homeObjOne,homeObjTwo,bannerObjOne}